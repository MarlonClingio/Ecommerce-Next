...
export default function AreaItemCarrinho(props: AreaItemCarrinhoProps) {
    return (
        <div className="flex items-center gap-5 bg-zinc-900 rounded-md overflow-hidden flex-wrap">
            ...
            <div className="flex flex-col justify-center flex-1 mx-3 my-1 flex-wrap">
            ...
            <div className="flex gap-2 items-center px-5 text-white my-2">
